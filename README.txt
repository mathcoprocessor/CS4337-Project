...
Source Packages: 
	bean:
		...
		MainPageBean.java		Lists theaters in Collin County, as well as shows all movies playing in all theaters.
	...
	entity:
		Movie.java				Entity mapping for the movie table.  Also contains preparedStatements for use by EJB.
		Showing.java			Entity mapping for the showing join table.  Also contains preparedStatements for use by EJB.
		Theater.java			Entity mapping for the theater table.  Also contains preparedStatements for use by EJB.
